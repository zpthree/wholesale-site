...
})(["display:flex;flex-direction:column;justify-content:center;height:100%;@media screen and (min-width:768px){padding:10rem 0;}form{width:100%;max-width:45rem;display:flex;flex-direction:column;border-radius:0.3rem;background:#fff;box-shadow:0 0 0.1rem 0.1rem rgba(0,0,0,0.1);padding:2rem 4rem 3rem;margin:auto;@media screen and (min-width:768px){padding:0 4rem 3rem;}fieldset{border:none;}.form-row{width:100%;flex-direction:column;&:not(:last-child){margin-bottom:1.5rem;}}input{width:100%;height:4.5rem;margin:1rem 0;padding:1.5rem;border:0.1rem solid ", ";border-radius:0.2rem;}#remember-me{display:flex;align-items:center;margin-top:-1rem;margin-bottom:1rem;input{height:0.9rem;width:0.9rem;margin-right:1rem;}p{color:", ";font-size:1.4rem;font-weight:500;margin:0;cursor:pointer;}&:hover p{color:", ";}}}h3{margin:1rem 0;padding:1rem 0;width:100%;text-align:center;color:", ";}p{margin:auto 0 2rem;}"], function (props) {
...
//# sourceMappingURL=sign-in.js.7e1d70446e073faf3e8a.hot-update.js.map