...
/* harmony import */ var _Input__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./Input */ "./components/Input.js");
/* harmony import */ var _styles_Btn__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ./styles/Btn */ "./components/styles/Btn.js");
/* harmony import */ var _lib_isEmpty__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ../lib/isEmpty */ "./lib/isEmpty.js");
/* harmony import */ var _lib_isEmpty__WEBPACK_IMPORTED_MODULE_19___default = /*#__PURE__*/__webpack_require__.n(_lib_isEmpty__WEBPACK_IMPORTED_MODULE_19__);
/* harmony import */ var _lib_validation__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ../lib/validation */ "./lib/validation.js");
...
})(["h4{color:", ";}h5{margin-bottom:1rem;}.permission-options{display:flex;}.form-row.permissions .row-full{@media screen and (min-width:768px){display:flex;flex-direction:row;label p{margin-right:1rem;margin-left:0;}}}"], function (props) {
...
function (_Component) {
  ...
  function CreateUser() {
    ...
    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_10__["default"])(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_8__["default"])(_this), "validateInput", function (e) {
      ...
      if (name === 'firstName' && Object(_lib_validation__WEBPACK_IMPORTED_MODULE_20__["validateFirstName"])(value)) {
        error.firstName = Object(_lib_validation__WEBPACK_IMPORTED_MODULE_20__["validateFirstName"])(value);
      }

      if (name === 'username' && Object(_lib_validation__WEBPACK_IMPORTED_MODULE_20__["validateUsername"])(value)) {
        error.username = Object(_lib_validation__WEBPACK_IMPORTED_MODULE_20__["validateUsername"])(value);
      }

      if (name === 'permissions' && Object(_lib_validation__WEBPACK_IMPORTED_MODULE_20__["validatePermissions"])(value)) {
        error.permissions = Object(_lib_validation__WEBPACK_IMPORTED_MODULE_20__["validatePermissions"])(value);
      }

      if (name === 'password' && Object(_lib_validation__WEBPACK_IMPORTED_MODULE_20__["validatePassword"])(value)) {
        error.password = Object(_lib_validation__WEBPACK_IMPORTED_MODULE_20__["validatePassword"])(value);
      }

      if (name === 'confirmPassword' && Object(_lib_validation__WEBPACK_IMPORTED_MODULE_20__["validateConfirmPassword"])(value)) {
        error.confirmPassword = Object(_lib_validation__WEBPACK_IMPORTED_MODULE_20__["validateConfirmPassword"])(value);
      } else if (name === 'confirmPassword' && Object(_lib_validation__WEBPACK_IMPORTED_MODULE_20__["comparePasswords"])(value)) {
        error.comparePasswords = Object(_lib_validation__WEBPACK_IMPORTED_MODULE_20__["comparePasswords"])(value);
      }
    ...
    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_10__["default"])(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_8__["default"])(_this), "validateForm", function () {
      ...
      if (Object(_lib_validation__WEBPACK_IMPORTED_MODULE_20__["validateFirstName"])(_this.state.firstName)) {
        error.firstName = Object(_lib_validation__WEBPACK_IMPORTED_MODULE_20__["validateFirstName"])(_this.state.firstName);
      }

      if (Object(_lib_validation__WEBPACK_IMPORTED_MODULE_20__["validateUsername"])(_this.state.username)) {
        error.username = Object(_lib_validation__WEBPACK_IMPORTED_MODULE_20__["validateUsername"])(_this.state.username);
      }

      if (Object(_lib_validation__WEBPACK_IMPORTED_MODULE_20__["validatePermissions"])(_this.state.permissions)) {
        error.permissions = Object(_lib_validation__WEBPACK_IMPORTED_MODULE_20__["validatePermissions"])(_this.state.permissions);
      }

      if (Object(_lib_validation__WEBPACK_IMPORTED_MODULE_20__["validatePassword"])(_this.state.password)) {
        error.password = Object(_lib_validation__WEBPACK_IMPORTED_MODULE_20__["validatePassword"])(_this.state.password);
      }

      if (Object(_lib_validation__WEBPACK_IMPORTED_MODULE_20__["validateConfirmPassword"])(_this.state.confirmPassword)) {
        error.confirmPassword = Object(_lib_validation__WEBPACK_IMPORTED_MODULE_20__["validateConfirmPassword"])(_this.state.confirmPassword);
      } else if (Object(_lib_validation__WEBPACK_IMPORTED_MODULE_20__["comparePasswords"])(_this.state.confirmPassword)) {
        error.comparePasswords = Object(_lib_validation__WEBPACK_IMPORTED_MODULE_20__["comparePasswords"])(_this.state.password, _this.state.confirmPassword);
      }
    ...
    value: function render() {
      ...
      return react__WEBPACK_IMPORTED_MODULE_12___default.a.createElement(react_apollo__WEBPACK_IMPORTED_MODULE_13__["Mutation"], {
        ...
        return react__WEBPACK_IMPORTED_MODULE_12___default.a.createElement(CreateUserStyles, {
          ...
          __self: this
        }, react__WEBPACK_IMPORTED_MODULE_12___default.a.createElement(_styles_Btn__WEBPACK_IMPORTED_MODULE_18__["default"], {
          type: "submit",
          id: "createUser",
          name: "createUser",
          disabled: !_lib_isEmpty__WEBPACK_IMPORTED_MODULE_19___default()(errorMessage),
          __source: {
            fileName: _jsxFileName,
            lineNumber: 467
          },
          __self: this
        }, "Submit"), react__WEBPACK_IMPORTED_MODULE_12___default.a.createElement(_styles_Btn__WEBPACK_IMPORTED_MODULE_18__["default"], {
          type: "cancel",
          id: "cancelUser",
          name: "cancelUser",
...
Input.propTypes = {
  ...
  value: PropTyles.string.isRequired,
...
//# sourceMappingURL=add-user.js.c198198192a751a51757.hot-update.js.map